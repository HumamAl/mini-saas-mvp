...
Previously built a 6-module fleet SaaS with multi-role access and complex relational data — same quality bar.

Is this for a single team or does each client need their own isolated instance? That decision shapes the architecture from day one.
