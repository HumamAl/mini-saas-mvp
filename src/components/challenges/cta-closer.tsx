...
export function CtaCloser({
  headline = "Ready to discuss the architecture? Let's talk.",
  subtext = "Let's walk through how these solutions apply to your specific setup — RBAC model, data layer, deployment pipeline.",
